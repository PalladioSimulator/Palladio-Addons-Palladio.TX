...
public class PcmtxSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PcmtxPackage.ENTITY_TYPE: {
				EntityType entityType = (EntityType)theEObject;
				T result = caseEntityType(entityType);
				if (result == null) result = caseResourceType(entityType);
				if (result == null) result = caseUnitCarryingElement(entityType);
				if (result == null) result = caseResourceInterfaceProvidingEntity(entityType);
				if (result == null) result = caseEntity(entityType);
				if (result == null) result = caseIdentifier(entityType);
			...
			case PcmtxPackage.COMMIT_ACTION: {
				CommitAction commitAction = (CommitAction)theEObject;
				T result = caseCommitAction(commitAction);
				if (result == null) result = caseAbstractInternalControlFlowAction(commitAction);
				if (result == null) result = caseAbstractAction(commitAction);
				if (result == null) result = caseEntity(commitAction);
				if (result == null) result = caseIdentifier(commitAction);
				if (result == null) result = caseNamedElement(commitAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PcmtxPackage.ABORT_ACTION: {
				AbortAction abortAction = (AbortAction)theEObject;
				T result = caseAbortAction(abortAction);
				if (result == null) result = caseAbstractInternalControlFlowAction(abortAction);
				if (result == null) result = caseAbstractAction(abortAction);
				if (result == null) result = caseEntity(abortAction);
				if (result == null) result = caseIdentifier(abortAction);
				if (result == null) result = caseNamedElement(abortAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Data Repository</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Data Repository</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDataRepository(DataRepository object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Commit Action</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Commit Action</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCommitAction(CommitAction object) {
		return null;
	}
