...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcmtx.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_rows_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_rows_feature", "_UI_Table_type"),
				 PcmtxPackage.Literals.TABLE__ROWS,
				 true,
				 false,
				 false,
	...
	protected void addTypesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_types_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_types_feature", "_UI_Table_type"),
				 PcmtxPackage.Literals.TABLE__TYPES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDatabasePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_database_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_database_feature", "_UI_Table_type"),
				 PcmtxPackage.Literals.TABLE__DATABASE,
				 true,
				 false,
				 true,
				 null,
